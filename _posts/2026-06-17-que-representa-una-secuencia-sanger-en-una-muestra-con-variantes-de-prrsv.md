...
image_alt: A group of spotted pigs crowd together in a farm pen, displaying natural behavior.
...
La secuenciación Sanger es una herramienta sólida para caracterizar la variante dominante de una muestra. Sin embargo, una secuencia consenso no necesariamente refleja toda la diversidad viral existente, especialmente cuando se analizan pools o muestras con poblaciones mixtas.
...
Una secuencia limpia permite identificar la variante consenso que predominó en el producto analizado. Por ello, conviene evitar afirmaciones como:

Todos los animales presentaban la misma cepa.

Una interpretación más precisa sería:

En la muestra analizada se obtuvo una secuencia consenso relacionada con determinada variante de PRRSV.
